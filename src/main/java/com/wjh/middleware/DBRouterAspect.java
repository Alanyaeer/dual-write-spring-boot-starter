...
//
//    @Around("aopPoint() && @annotation(com.wjh.middleware.annotation.DBRouter)")
//    public Object doRouter(ProceedingJoinPoint joinPoint, DBRouter dbRouter) throws Throwable {
//        boolean dualWrite = dbRouter.dualWrite();
//        if(dualWrite) DBContextHolder.setDataSourceKey(IGNITE_DATA_SOURCE);
//        else DBContextHolder.setDataSourceKey(MYSQL_DATA_SOURCE);
//        try {
